...
`+src;
src=src.replace(/new THREE\.WebGLRenderer\([^)]*\)/,'(globalThis.__rstub())');
src=`globalThis.__rstub=()=>{const r={domElement:{addEventListener(){},style:{}},shadowMap:{},capabilities:{getMaxAnisotropy:()=>8},
